...
VERSIÓN    : 17.0 (FUSIÓN DOCUMENTAL - ARQUITECTURA LIMPIA)
=============================================================================
"""
...
def buscar_exoplanetas(coordenadas, radio_arcsec=60):
    ...
    except Exception as e: print(f"   [-] Error en catálogo NASA: {e}")
...
def analizar_espectroscopia_activa(coordenadas, id_evento):
    ...
    if fuente_espectro == "Ninguna":
        ...
        except Exception: estado_radar_eso = "Radar ESO Inaccesible"
...
# =====================================================================
# MODIFICADO: RECIBE E INYECTA EL REPORTE MATEMÁTICO
# =====================================================================
...
"""
    if tiene_planetas and planetas_info: contenido += f"    SISTEMA CONFIRMADO: {len(planetas_info)} exoplaneta(s) en órbita.\n"
    else: contenido += "    SISTEMA AISLADO: No se registran planetas confirmados (Radio revisado: 60 arcsec).\n"
    ...
    if tipo_evento == "flare" and tiene_planetas: contenido += "    PRIORIDAD   : MÁXIMA PRIORIDAD ESPACIAL\n    INSTRUMENTO : Recomendado para JWST o ELT.\n"
    else: contenido += "    PRIORIDAD   : PRIORIDAD ESTÁNDAR DE MONITOREO\n    INSTRUMENTO : Telescopios terrestres (Fotometría).\n"
    
    # INYECCIÓN MATEMÁTICA
...
# =====================================================================
# EL ENRUTADOR PRINCIPAL (AHORA ACEPTA EL REPORTE MATEMÁTICO)
# =====================================================================
def ejecutar_pipeline_magallanes(ra_deg, dec_deg, id_evento="Desconocido", tipo_evento="flare", distancia_real="Desconocida", mjd_deteccion=None, reporte_matematico=""):
    ...
    try:
        ...
        if tipo_evento in ["flare", "nova"]:
            ...
            # PASAMOS EL REPORTE MATEMÁTICO A LA FUNCIÓN
            ...
            try:
                generar_alerta_comunidad(id_limpio, ra_deg, dec_deg, tipo_evento=tipo_evento, extra_data={
                    "ew_halfa": valor_ew, 
                    "tiene_planetas": tiene_planetas, 
                    "distancia": distancia_real,
                    "mjd_deteccion": mjd_deteccion,          # <--- INYECCIÓN DE TIEMPO
                    "es_enana_roja": es_enana_roja,          # <--- VARIABLE SED
                    "fuente_espectro": fuente_espectro       # <--- FUENTE BI-HEMISFÉRICA
                })
            except TypeError: pass
                
        # --- VÍA 2: EXTRAGALÁCTICO ---
...
if __name__ == "__main__":
    print("=====================================================")
    print(f" ESTACIÓN MAGALLANES - LABORATORIO (MODO LOCAL = {MODO_LOCAL})")
    print("=====================================================")
    try:
